...
class JFormFieldFontGroups extends JFormField {
	protected $type = 'FontGroups';
	
	protected function getInput() {
		// define DS to avoid problem with file reading
		...
		$html .= '<div><p><label>'.JText::_('TPL_GK_LANG_CONFIG_LOAD').'</label>'.$file_select.'<button id="config_manager_load" class="btn"><i class="fa fa-download"></i> '.JText::_('TPL_GK_LANG_CONFIG_LOAD_BTN').'</button></p></div>';
		$html .= '<div class="input-append"><p><label>'.JText::_('TPL_GK_LANG_CONFIG_SAVE').'</label><input type="text" id="config_manager_save_filename" class="input-medium" placeholder="'.JText::_('TPL_GK_LANG_CONFIG_YOUR_FILENAME').'" /><span class="add-on">.json</span><button id="config_manager_save" class="btn"><i class="fa fa-upload"></i> '.JText::_('TPL_GK_LANG_CONFIG_SAVE_BTN').'</button></p></div>';
		$html .= '<div><p><label>'.JText::_('TPL_GK_LANG_CONFIG_DELETE').'</label>'.$file_delete.'<button id="config_manager_delete" class="btn"><i class="fa fa-remove"></i> '.JText::_('TPL_GK_LANG_CONFIG_DELETE_BTN').'</button></p></div>';

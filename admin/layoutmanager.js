		...
		if(jQuery(e.target).hasClass('JoomlaWidth')) {
			...
			if(jQuery(e.target).is(':checked')) {
				...
				jQuery.each(mods, function(i, module) {
					...
					html += '<button class="btn btn-link btn-mini decWidth"><i class="fa fa-minus"></i></button><input class="width" value="'+value+'" type="text"><button class="btn btn-link btn-mini incWidth"><i class="fa fa-plus"></i></button><button class="btn btn-link btn-mini removeModule"><i class="fa fa-remove"></i></button></div></div>';

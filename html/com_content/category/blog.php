...
?>
	<script type="text/javascript">
		jQuery(function(){
			jQuery('.faq-underline').parent().next().css("display","none");
			jQuery('.faq-underline').click(function(){
...
?>
	...
	<?php
    		...
    		if ($rowcount==1) : 
    	?>
	<div class="items-row cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$rowcount ; ?> row-fluid">
		<?php endif; ?>

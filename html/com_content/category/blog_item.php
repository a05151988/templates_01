...
$useFaqLayoutForBlogItem = false;

if($this->item->category_title=="常見問題")
{
	$useFaqLayoutForBlogItem = true;
}

?>

<?php if($useFaqLayoutForBlogItem): ?>	
	<h3>
	  <span class="faq-underline"><?php echo $this->item->title;  ?></span>
	</h3>

	...
	<table class="category table table-striped table-bordered table-hover">
		...
		<thead>
			<tr>
				...
				<?php if ($date = $this->params->get('list_show_date')) : ?>
					<?php $date_title = ($this->items[0]->catid == 9) ? '活動日期' : 'COM_CONTENT_' . $date . '_DATE'; ?>
					<th id="categorylist_header_date">
						...
						<?php elseif ($date == "published") : ?>
							<?php echo JHtml::_('grid.sort', $date_title , 'a.publish_up', $listDirn, $listOrder); ?>
						<?php endif; ?>
					</th>
				<?php endif; ?>
		...
		<tbody>
			<?php foreach ($this->items as $i => $article) : ?>
				...
				<?php endif; ?>
					<?php
						$diffDate = JMyDate::relative($article->displayDate,"day");
					?>
					<td <?php echo $headerTitle; ?> class="list-title">
						<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
							...
							<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language)); ?>" title="<?php echo $this->escape($article->title); ?>">

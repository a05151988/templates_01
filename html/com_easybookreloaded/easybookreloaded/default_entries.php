        ...
        <div class="easy_frame" <?php if(!$entry->published) : ?>style="background-color: #fffefd; border: #ffb39b solid 1px;"<?php endif; ?>>
            <div class="easy_top" <?php if(!$entry->published) : ?>style="background-color: #FFE7D7;"<?php endif; ?>>
                <div class="easy_top_left">
                    <strong class="easy_big" id="gbentry_<?php echo $entry->id; ?>">
						<?php if((($entry->user_id == $user->id || EASYBOOK_ADMIN) && $entry->gbsecret == 1) || $entry->gbsecret == 0) : ?>
						<?php echo $entry->gbname; ?>
						<?php else : ?>
						<?php echo JTEXT::_('COM_EASYBOOKRELOADED_ANONYMOUS'); ?>
						<?php endif; ?>
					</strong>
                ...
                <div class="easy_top_right">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="easy_top_right_admin">
							...
							<?php endif; ?>
							<?php if($entry->user_id == $user->id || EASYBOOK_ADMIN) : ?>
            ...
            <?php if(!empty($entry->gbtitle) AND $this->params->get('show_title', true)) : ?>
                <div class="easy_title">
					...
					<?php else : ?>
					<?php echo JText::_('COM_EASYBOOKRELOADED_SECRET'); ?>
					<?php endif ?>
				</div>
            <?php endif; ?>

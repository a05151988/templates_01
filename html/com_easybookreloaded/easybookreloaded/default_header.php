...
<div class="page-header">
	<h1> <?php echo JText::_('COM_EASYBOOKRELOADED_PAGE_HEADER'); ?> </h1>
</div>
<?php if(EASYBOOK_CANADD AND !$this->params->get('offline')) : ?>
    <div class="sign">
        <strong>
            <a class="sign" href="<?php echo JRoute::_('index.php?option=com_easybookreloaded&controller=entry&task=add'); ?>" title="<?php echo JText::_('COM_EASYBOOKRELOADED_SIGN_GUESTBOOK'); ?>">
                <button class="btn">
                  <i class="fa fa-plus"></i>&nbsp;<?php echo JText::_('COM_EASYBOOKRELOADED_SIGN_GUESTBOOK'); ?>
                </button>
            </a>
        </strong>
    </div>
<?php else: ?>
	<div class="login_notification"><?php echo JText::_('COM_EASYBOOKRELOADED_LOGIN_NOTIFICATION'); ?></div>
<?php endif; ?>

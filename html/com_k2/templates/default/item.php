	...
	<?php
		...
		<aside class="itemAsideInfo">
			...
			<dl class="article-info">
				...
				<dt class="itemResizer"> <span><?php echo JText::_('K2_FONT_SIZE'); ?></span> </dt><dd><a href="#" id="fontDecrease"><i class="fa fa-minus"></i></a> <a href="#" id="fontIncrease"><i class="fa fa-plus"></i></a> </dd>
				<?php endif; ?>
